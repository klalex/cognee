...
RUN --mount=type=cache,target=/root/.cache/uv \
    ...
    uv sync "$@" --extra fastembed --extra debug --extra api --extra postgres --extra neo4j --extra falkor --extra tracing --extra monitoring --extra llama-index --extra aws --extra ollama --extra mistral --extra groq --extra anthropic --frozen --no-install-project --no-dev --no-editable
...
RUN --mount=type=cache,target=/root/.cache/uv \
    ...
    uv sync "$@" --extra fastembed --extra debug --extra api --extra postgres --extra neo4j --extra falkor --extra tracing --extra monitoring --extra llama-index --extra aws --extra ollama --extra mistral --extra groq --extra anthropic --frozen --no-dev --no-editable
