...
RUN --mount=type=cache,target=/root/.cache/uv \
    uv sync --extra debug --extra api --extra postgres --extra neo4j --extra falkor --extra tracing --extra monitoring --extra anthropic --frozen --no-install-project --no-dev --no-editable
...
COPY ./kuzu /app/kuzu
RUN --mount=type=cache,target=/root/.cache/uv \
    uv sync --extra debug --extra api --extra postgres --extra neo4j --extra falkor --extra tracing --extra monitoring --extra anthropic --frozen --no-dev --no-editable --extra aws
